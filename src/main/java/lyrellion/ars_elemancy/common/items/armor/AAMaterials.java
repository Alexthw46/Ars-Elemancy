...
public class AAMaterials {
    ...
    public static Holder<ArmorMaterial> tempest;
    public static Holder<ArmorMaterial> silt;
    public static Holder<ArmorMaterial> mire;
    public static Holder<ArmorMaterial> vapor;
    public static Holder<ArmorMaterial> lava;
    public static Holder<ArmorMaterial> cinder;
    public static Holder<ArmorMaterial> elemancer;
}